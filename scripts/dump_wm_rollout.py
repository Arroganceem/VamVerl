...
Example (on cluster GPU node):
  python scripts/dump_wm_rollout.py --index 0
  python scripts/dump_wm_rollout.py --index 0 --diagnose
"""
...
def main() -> int:
    ...
    from vampo.imagination.rollout import ImaginationRollout
    ...
    backend = InProcessVLABackend(policy, prompt=prompt)
