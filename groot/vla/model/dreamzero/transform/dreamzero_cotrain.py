...
def _resolve_local_tokenizer_path(name: str) -> str:
    ...
    if not offline and not name.startswith("google/"):
        return name
    candidates = [
        os.environ.get("TOKENIZER_PATH"),
        os.path.join(os.environ.get("WAN21_DIR", ""), "google", "umt5-xxl"),
        "/home/robotem/Models/umt5-xxl",
        os.path.join(os.environ.get("WAN22_DIR", ""), "google", "umt5-xxl"),
    ]
...
class HuggingfaceTokenizer:
    ...
    def __init__(self, name, seq_len=None, clean=None, **kwargs):
        ...
        name = _resolve_local_tokenizer_path(name)
        self.name = name
