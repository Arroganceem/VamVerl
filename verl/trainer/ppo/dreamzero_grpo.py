...
from verl.utils.vla.log_prob_utils import _format_lp_values
...
def compute_dreamzero_grpo_outcome_advantage(
...
def compute_dreamzero_grpo_from_batch(data: DataProto, config) -> tuple[torch.Tensor, torch.Tensor]:
    ...
    return compute_dreamzero_grpo_outcome_advantage(
